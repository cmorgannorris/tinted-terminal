...
ghostty_palette_color_0="#282a36"
...
ghostty_palette_color_8="#44475a"
...
ghostty_palette_color_17="#ffb86c"
...
_theme_file() {
  cat <<EOF
# vim: ft=ghostty
# nosferatu theme for Ghostty
# Scheme Author: morgan
...
_palette_value() {
  ...
  case "$1" in
  "0")
    echo $ghostty_palette_color_0
    ;;
  "1")
    echo $ghostty_palette_color_1
    ;;
  "2")
    echo $ghostty_palette_color_2
    ;;
  "3")
    echo $ghostty_palette_color_3
    ;;
  "4")
    echo $ghostty_palette_color_4
    ;;
  "5")
    echo $ghostty_palette_color_5
    ;;
  "6")
    echo $ghostty_palette_color_6
    ;;
  "7")
    echo $ghostty_palette_color_7
    ;;
  "8")
    echo $ghostty_palette_color_8
    ;;
  "9")
    echo $ghostty_palette_color_9
    ;;
  "10")
    echo $ghostty_palette_color_10
    ;;
  "11")
    echo $ghostty_palette_color_11
    ;;
  "12")
    echo $ghostty_palette_color_12
    ;;
  "13")
    echo $ghostty_palette_color_13
    ;;
  "14")
    echo $ghostty_palette_color_14
    ;;
  "15")
    echo $ghostty_palette_color_15
    ;;
  "16")
    echo $ghostty_palette_color_16
    ;;
  "17")
    echo $ghostty_palette_color_17
    ;;
  "18")
    echo $ghostty_palette_color_18
    ;;
  "19")
    echo $ghostty_palette_color_19
    ;;
  "20")
    echo $ghostty_palette_color_20
    ;;
  "21")
    echo $ghostty_palette_color_21
    ;;
  esac
}
